...
titulo=Label(root, text=("SUPERMARK"),bd=5, relief=FLAT, 
             font=("arial black", 35), bg="#F49739", fg="#0068DD").pack(fill=X)
subtitulo=Label(root, text=("LOS MEJORES PRECIOS ESTAN AQUI!!!"),bd=5, relief=FLAT, 
             font=("arial black", 15), bg="#F49739", fg="#0068DD").pack(fill=Y)             
...
img=PhotoImage(file="Supermark\src\screen\logosupermark_1.gif")
...
datos_clientes=LabelFrame(root, text="CLIENTES", font=("arial black", 14),
                          bd=10, background="#0068DD", foreground="#FAF4F2", relief=FLAT)
datos_clientes.place(x=0, y=120, relwidth=1)

nombre=Label(datos_clientes, text="Usuario", font=("arial black", 12), 
             bg="#F49739", foreground="#040100").grid(row=0, column=0, padx=8)
...
direccion=Label(datos_clientes, text="Dirección", font=("arial black", 12),
                bg="#F49739", foreground="#040100").grid(row=0, column=3, padx=8)
...
carrito=Label(datos_clientes, text="Carrito $", font=("arial black", 12), 
              bg="#F49739", foreground="#040100").grid(row=0, column=8, padx=8)
...
cerrar_sesion=Button(datos_clientes,text="Cerrar Sesión", font=("arial black", 10), 
                    bg="#F49739", foreground="#040100").grid(row=0, column=12, padx=8)                         
...
factura=Listbox(root, width=50, font=("arial black", 10),foreground="#040100", background="#0068DD" )
...
lista_productos=Listbox(root, width=50, font=("arial black", 10), foreground="#040100", background="#0068DD")
...
boton_factura=Button(boton_frame, text="IMPRIMIR FACTURA", width=20, font=("arial black", 10), 
                     bg="#F49739", foreground="#040100").grid(row=0, column=0,
                     padx=12, pady=12)


boton_comprar=Button(boton_frame, text="HISTORIAL DE COMPRA", width=20, font=("arial black", 10), 
                     bg="#F49739", foreground="#040100").grid(row=0, column=1,
                     padx=10, pady=6)
