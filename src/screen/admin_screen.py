from tkinter import (Button, Canvas, Frame, PhotoImage, Tk, Toplevel,
                     messagebox, ttk)
...
class Admin(Toplevel):
    ...
    def ventana_inicio(self):
        ...
        b10 = Button(canvas,
                     ...
                     borderwidth=0,
                     highlightthickness=0,
                     command=lambda: self.mostrar_productos_sql(
    ...
    def cargar_seleccion_treeview(self, treeview: ttk.Treeview):
        self.id_producto = treeview.item(treeview.focus())["text"]
        self.nombre_producto = treeview.item(treeview.focus())["values"][1]
        self.categoria_producto = treeview.item(treeview.focus())["values"][2]
        self.precio_producto = treeview.item(treeview.focus())["values"][3]
        self.stock_producto = treeview.item(treeview.focus())["values"][4]
        self.descri_producto = treeview.item(treeview.focus())["values"][5]
